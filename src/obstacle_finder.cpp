...
ObstacleFinder::ObstacleFinder(costmap_2d::Costmap2DROS* costmap, double robot_odom_x, double robot_odom_y) : costmap_(costmap), robot_odom_x_(robot_odom_x), robot_odom_y_(robot_odom_y) {}
...
Obstacle ObstacleFinder::nearestObstacle(costmap_2d::Costmap2DROS* new_costmap, double robot_odom_x, double robot_odom_y)
{
